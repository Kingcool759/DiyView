...
/**
 * @data on 5/13/21 11:24 AM
 * @auther
 * @describe 奥运五环图
 */
public class FiveRingsViewGroup extends ViewGroup {
    ...
    public FiveRingsViewGroup(Context context) {
        this(context, null);
    }

    public FiveRingsViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FiveRingsViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
